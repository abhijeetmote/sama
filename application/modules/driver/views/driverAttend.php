				...
				<div class="col-xs-12">
					...
					<form class="form-horizontal" role="form" id="driverattn">						
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<label>
									<input type="radio" class="ace" <?php if(isset($driver[0]->day_type) && $driver[0]->day_type == 1) { echo "checked";} ?> value="1" name="daytype" id="half">
										<span class="lbl">Half Day</span>
									</label>

									<label>
										<input type="radio" class="ace" value="2" <?php if(isset($driver[0]->day_type) && $driver[0]->day_type == 2) { echo "checked";} ?> name="daytype" id="full">
