				...
				<div class="col-xs-12">
					...
					<form class="form-horizontal" role="form" id="<?php if(isset($driver)): echo "driver_update"; else: echo "drivermaster"; endif; ?>">						
						<div class="form-group">
							...
							<div class="col-sm-4">
								<input type="text" id="driver_fname" name="driver_fname" value="<?php if(isset($driver)): echo $driver[0]->driver_fname; endif; ?>" placeholder="Enter Labour First Name" class="col-xs-10 col-sm-12 mandatory-field" onKeyUp="javascript:return check_isalphanumeric(event,this);"/>
							...
							<div class="col-sm-4">
								<input type="text" id="driver_mname" name="driver_mname" value="<?php if(isset($driver)): echo $driver[0]->driver_mname; endif; ?>" placeholder="Enter Labour Middle Name" class="col-xs-10 col-sm-12" onKeyUp="javascript:return check_isalphanumeric(event,this);"/>
								<span class="help-inline col-xs-12 col-sm-7">
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<input type="text" id="driver_lname" name="driver_lname" placeholder="Enter Labour Last Name" value="<?php if(isset($driver)): echo $driver[0]->driver_lname; endif; ?>" class="col-xs-10 col-sm-12 mandatory-field" onKeyUp="javascript:return check_isalphanumeric(event,this);"/>
								<span class="help-inline col-xs-12 col-sm-7">
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<textarea id="driver_address" name="driver_address" value="<?php if(isset($driver)): echo $driver[0]->driver_add; endif; ?>" placeholder="Enter Labour Address" class="col-xs-10 col-sm-12 mandatory-field" ><?php if(isset($driver)): echo trim($driver[0]->driver_add); endif; ?></textarea>
								<span class="help-inline col-xs-12 col-sm-7">
							...
							<div class="col-sm-4">
								<input type="text" id="driver_mobile" name="driver_mobile" onblur="javascript:return check_ismobile(event,this,0);" value="<?php if(isset($driver)): echo $driver[0]->driver_mobno; endif; ?>" placeholder="Enter Labour Mobile No" class="col-xs-10 col-sm-12 mandatory-field"  onKeyUp="javascript:return check_isnumeric(event,this,0);" />
								<span class="help-inline col-xs-12 col-sm-7">
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<input type="text" id="driver_mobile1" name="driver_mobile1" onblur="javascript:return check_ismobile(event,this,0);" value="<?php if(isset($driver)): echo $driver[0]->driver_mobno1; endif; ?>" placeholder="Enter Labour Mobile No" class="col-xs-10 col-sm-12" onKeyUp="javascript:return check_isnumeric(event,this,0);"/>
								<span class="help-inline col-xs-12 col-sm-7">
