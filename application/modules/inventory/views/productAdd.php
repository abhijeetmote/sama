		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-xs-12">
					...
					<!-- PAGE CONTENT BEGINS -->
					<form class="form-horizontal" role="form" id="<?php if(isset($update)): echo "productUpdate"; else: echo "productAdd"; endif; ?>">						
						...
						<input type="hidden" value="<?php if(isset($product)): echo $product[0]->p_id; endif; ?>" name="p_id">
						<div class="form-group">
						...
						<div class="clearfix form-actions">
							<div class="col-md-offset-3 col-md-9">
								<button class="btn btn-info" type="submit">
									...
									<?php if(isset($update)): echo "Update"; else: echo "Submit"; endif; ?>
								</button>
