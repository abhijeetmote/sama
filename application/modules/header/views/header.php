				...
				<ul class="nav nav-list">
					...
					<li class="">
						...
						<ul class="submenu">
							...
							<li class="">
								<a href="<?php echo base_url(); ?>site/viewsite">
									<i class="menu-icon fa fa-caret-right"></i>
					...
					<li class="">
						...
						<ul class="submenu">
							...
							<li class="">
								<a href="<?php echo base_url(); ?>contractor/contractorMaster">
									<i class="menu-icon fa fa-caret-right"></i>
							...
							<li class="">
								<a href="<?php echo base_url(); ?>contractor/contractorList">
									<i class="menu-icon fa fa-caret-right"></i>
					...
					<li class="">
						...
						<ul class="submenu">
							...
							<li class="">
								<a href="<?php echo base_url(); ?>payment/labourSal">
									<i class="menu-icon fa fa-caret-right"></i>
									Labour Salary
								</a>
