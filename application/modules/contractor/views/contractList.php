	...
	<div class="main-content-inner">
		<div class="breadcrumbs ace-save-state" id="breadcrumbs">
			<ul class="breadcrumb">
				...
				<li class="active">Assigned Contract Lists</li>
			</ul><!-- /.breadcrumb -->
				...
				<div class="col-xs-12">
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<form class="form" id="contractList"></form>
							<div>
								<table id="dynamic-table" class="table table-striped table-bordered table-hover">
									...
									<tbody>
										<?php 
												$i=1;
										foreach ($contractdetails as $val): ?>
											<tr>
												 
												<td><?php echo $i;?></td>
												<td><?php echo $val['contractor_name']; ?></td>
												<td><?php echo $val['site_name']; ?></td>
												<td><?php echo $val['contract_amt']; ?></td>
												<td><?php echo $val['start_date']; ?></td>
												<td>
													<div class="hidden-sm hidden-xs action-buttons">
														

														<a class="green" href="<?php echo base_url().'contractor/updatecontractdet/'.$val['contract_id']; ?>">
															<i class="ace-icon fa fa-pencil bigger-130"></i>
														</a>

														<a class="red delete" href="#" id="<?php echo $val['contract_id']; ?>">
