				...
				<div class="col-xs-12">
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<form class="form" id="labourList"></form>
							<div>
									...
									<tbody>
										<?php foreach ($list as $val): ?>
											<tr>
												...
												<td><?php echo $val->labour_fname." ".$val->labour_lname; ?></td>
												<td><?php echo $val->labour_mobno; ?></td>
												<td><?php echo $val->labour_mobno1; ?></td>
												<td><?php echo $val->labour_add; ?></td>
												<td>
													<div class="hidden-sm hidden-xs action-buttons">
														

														<a class="green" href="<?php echo base_url().'labour/update/'.$val->labour_id; ?>">
															<i class="ace-icon fa fa-pencil bigger-130"></i>
														</a>

														<a class="red delete" href="#" id="<?php echo $val->labour_id; ?>">
