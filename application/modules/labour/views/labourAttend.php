		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-xs-12">
					...
					<!-- PAGE CONTENT BEGINS -->
					<form class="form-horizontal" role="form" id="labourattn">						
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								...
								<input type="text" id="staff_in_dt" data-date-format="dd-mm-yyyy" name="labour_in_dt" placeholder="Enter Inn Date" class="col-xs-10 col-sm-5 mandatory-field" 
