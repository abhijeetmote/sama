	...
	<div class="main-content-inner">
		<div class="breadcrumbs ace-save-state" id="breadcrumbs">
			<ul class="breadcrumb">
				...
				<li class="active">Labour Attendance Report</li>
			</ul><!-- /.breadcrumb -->
		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-xs-6">
					...
					<!-- PAGE CONTENT BEGINS -->
					<form class="form-horizontal" role="form" id="labour">						
						<div class="form-group">
							<label class="col-sm-2 no-padding-right">Select Labour</label>

							<div class="col-sm-10">
								<select class="chosen-select form-control" name="labour" id="labour_name" data-placeholder="Choose a labour...">
									<?php
										foreach ($labour as $val) 
										{
											echo '<option value="'.$val->labour_id.'">'.$val->labour_fname.' '.$val->labour_lname.'</option>';
										}
									?>
...
<script type="text/javascript">
	$(document).on('click','#submit', function(e){
        ...
        var data = new FormData($("#labour")[0]);
