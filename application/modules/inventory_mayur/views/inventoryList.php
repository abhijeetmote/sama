				...
				<div class="col-xs-12">
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<form class="form" id="inventorylist"></form>
							<div>
									...
									<tbody>
										<?php foreach ($list as $val): ?>
											<tr id="itemid">
												...
												<td id="itmid"><?php echo $val->inven_items_id; ?></td>
												<td><?php echo $val->inven_items_name; ?></td>
												<td><?php echo $val->inven_items_unit; ?></td>
												<td><?php echo $val->inven_items_quantity; ?></td>
												<td><?php echo $val->inven_items_netcost; ?></td>
												<td><?php echo $val->added_on; ?></td>
												<td><?php if($val->status=1) {echo "Active";}else {echo "InAcitve";}?></td>	

												<td>
													<div class="hidden-sm hidden-xs action-buttons">
														

														<a class="green" href="<?php echo base_url().'inventory/update/'.$val->inven_items_id; ?>">
															<i class="ace-icon fa fa-pencil bigger-130"></i>
														</a>

														<a class="red delete" href="#" id="<?php echo $val->inven_items_id; ?>">
