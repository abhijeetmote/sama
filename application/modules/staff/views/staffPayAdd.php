		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-xs-12">
					...
					<!-- PAGE CONTENT BEGINS -->
					<form class="form-horizontal" role="form" id="<?php if(isset($staffpay)): echo "staff_payupdate"; else: echo "staffpay"; endif; ?>">						
					<div class="form-group">
							<label class="col-sm-2 control-label no-padding-right">Select Staff First Name</label>
								
							<div class="col-sm-4">
								<select class="chosen-select form-control" name="staff_f_name" id="form-field-select-3" data-placeholder="Choose a Staff FirstName...">
									<?php
