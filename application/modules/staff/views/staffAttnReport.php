		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-xs-6">
					...
					<!-- PAGE CONTENT BEGINS -->
					<form class="form-horizontal" role="form" id="staff">						
						<div class="form-group">
							<label class="col-sm-2 no-padding-right">Select Staff</label>

							<div class="col-sm-10">
								<select class="chosen-select form-control" name="staff" id="staff_name" data-placeholder="Choose a staff...">
									<?php
...
<script type="text/javascript">
	$(document).on('click','#submit', function(e){
        ...
        var obj = array.filter(function(obj){
            return obj.name === 'staffattendanceReport'
        })[0];

        var data = new FormData($("#staff")[0]);
