				...
				<div class="col-xs-12">
					...
					<form class="form-horizontal" role="form" id="<?php if(isset($staff)): echo "staff_update"; else: echo "staffmaster"; endif; ?>">						
						...
						<div class="form-group">
							...
							<div class="radio">								
							<label>
								<input name="staff_gen" value="Male" <?php if(isset($staff) && $staff[0]->staff_gender == M): ?>checked="checked"<?php ; endif; ?>
								<?php if(!isset($staff)): ?>checked="checked"<?php ; endif; ?> id="staff_gen" class="ace" type="radio">
								<span class="lbl">Male</span>
							</label
							<div class="radio">								
							<label>
								<input name="staff_gen" value="Female" <?php if(isset($staff) && $staff[0]->staff_gender == F): ?>checked="checked"<?php ; endif; ?> id="staff_gen" class="ace" type="radio">
