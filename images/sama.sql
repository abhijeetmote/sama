...
INSERT INTO `inventory` (`inventory_id`, `product_id`, `site_id`, `vendor_id`, `qty`, `price`, `total_amt`, `inventory_status`, `added_by`, `added_on`, `updated_by`) VALUES
(1, 1, 1, 5, 2, 10, 20, 1, 1, '2016-12-10 06:40:49', 0),
(2, 1, 1, 5, 5, 10, 50, 1, 1, '2016-12-10 06:58:54', 0),
(3, 1, 1, 5, 10, 10, 100, 1, 1, '2016-12-10 07:12:05', 0);
...
--
-- Dumping data for table `inventory_map`
--

INSERT INTO `inventory_map` (`inventory_map_id`, `p_id`, `s_id`, `v_id`, `qty`, `added_by`, `added_on`, `updated_by`, `updated_on`) VALUES
(1, 1, 1, 5, 17, 1, '2016-12-10 06:40:49', 1, '2016-12-10 07:12:05');
...
INSERT INTO `product_master` (`p_id`, `p_name`, `p_desc`, `p_unit`, `p_unit_price`, `isactive`, `added_by`, `added_on`, `updated_by`, `updated_on`) VALUES
(1, 'steel', 'steel', 1, 10, 0, 1, '2016-12-09 02:46:59', 0, '0000-00-00 00:00:00');
...
--
-- Dumping data for table `vendor_bill_payment_details`
--

INSERT INTO `vendor_bill_payment_details` (`vendor_bill_payment_id`, `product_id`, `inventory_id`, `inventory_date`, `vendor_id`, `site_id`, `to_ledger_id`, `from_ledger_id`, `vendor_bill_payment_amount`, `vendor_bill_payment_date`, `vendor_bill_payment_mode`, `vendor_bill_payment_comments`, `vendor_bill_payment_bank_name`, `vendor_bill_payment_cheque_number`, `vendor_bill_payment_card_num`, `added_by`, `added_on`, `updated_by`, `updated_on`, `status`, `payment_status`) VALUES
(3, 1, 3, '0000-00-00 00:00:00', 5, 1, 0, 0, 100.000, '0000-00-00', 'cheque', NULL, NULL, NULL, NULL, 1, '2016-12-10 07:12:05', NULL, NULL, '1', 'unpaid');
...
--
ALTER TABLE `inventory_map`
MODIFY `inventory_map_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
...
--
ALTER TABLE `vendor_bill_payment_details`
MODIFY `vendor_bill_payment_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
